...
Run this script with the command <code>sh 1\_request\_mycocosm\_annotations.sh <path/to/taxa_file> \<MycoCosm username\> \<MycoCosm password\> \<annotation type\></code>
